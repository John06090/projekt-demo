/**
 * Villa ärver Byggnad och har extra fält enligt UML.
 */
public class Villa extends Byggnad {
    ...
    public Villa(String kundNamn, String leveransAdress, int prisID, int orderID,
